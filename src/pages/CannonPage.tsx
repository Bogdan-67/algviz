...
export function CannonPage() {
  ...
  const currentCFull = useMemo(() => assembleCWithNulls(current.matrixC, current.b), [current])
      ...
      <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_360px]">
        <section className="flex flex-col gap-3 rounded-xl border border-slate-200 bg-white/60 p-4 dark:border-slate-700 dark:bg-slate-800/40">
          ...
          <div className="overflow-x-auto scroll-thin">
            <ProcessorGrid snapshot={current} expandedKey={expandedKey} onToggleExpand={toggleExpand} />
          </div>
        </section>
